...
const renderTripPoint = (tripListElement, tripPoint) => {
  ...
  const replaceTripPointToEditForm = () => {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["replace"])(editTripComponent.getElement(), tripComponent.getElement());
  };

  const replaceEditFormToTripCard = () => {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["replace"])(tripComponent.getElement(), editTripComponent.getElement());
  };
  ...
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripListElement, tripComponent.getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
};

const renderBoard = () =>{
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripControls, new _view_nav_template_js__WEBPACK_IMPORTED_MODULE_1__["default"]().getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripControls, new _view_trip_filters_js__WEBPACK_IMPORTED_MODULE_2__["default"]().getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripEvents, new _view_trip_sort_template_js__WEBPACK_IMPORTED_MODULE_3__["default"]().getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);

  if (points.length === 0) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripEvents, new _view_trip_List_Empty_js__WEBPACK_IMPORTED_MODULE_6__["default"]().getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
  } else {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripElement, new _view_info_trip_template_js__WEBPACK_IMPORTED_MODULE_0__["default"](points).getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getRandomBoolean */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: MIN_PRICE, MAX_PRICE, MAX_DESCRIPTIONS, HOURS_IN_DAY, MINUTES_IN_HOUR, TRIP_TYPES, CITY_DATA, DESCRIPTIONS_DATA, LABEL_OF_TYPES, PHOTO_DATA, SERVISES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class Abstract {
  ...
  getTemplate() {
    throw new Error(`Abstracr method not implemented: getTemplate`);
  }
  getElement() {
    if (!this._element) {
