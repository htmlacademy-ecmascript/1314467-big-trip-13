...
/*!********************************!*\
  !*** ./src/mocks/mocksData.js ***!
  \********************************/
/*! exports provided: getRandomDescriptions, getRandomServices, getSumCost, getTripDates, getTripRoute, generateTripPoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRandomDescriptions", function() { return getRandomDescriptions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRandomServices", function() { return getRandomServices; });
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: MIN_PRICE, MAX_PRICE, MAX_DESCRIPTIONS, QUANTITY_PINS, HOURS_IN_DAY, MINUTES_IN_HOUR, TRIP_TYPES, CITY_DATA, DESCRIPTIONS_DATA, PHOTO_DATA, SERVISES, Mode, SortMode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
/* harmony import */ var _mocks_mocksData_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mocks/mocksData.js */ "./src/mocks/mocksData.js");
...
const createAvailableTypes = (selectedType) => {
  return _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["TRIP_TYPES"].map((type) => {
...
class EditTrip extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _typeChangeHandler(evt) {
    ...
    this.updateData({
      ...
      offers: Object(_mocks_mocksData_js__WEBPACK_IMPORTED_MODULE_2__["getRandomServices"])()
    });
  }
