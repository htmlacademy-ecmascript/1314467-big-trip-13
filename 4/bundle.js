...
/* harmony import */ var _view_trip_day_counter_template_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/trip-day-counter-template.js */ "./src/view/trip-day-counter-template.js");
/* harmony import */ var _view_trip_day_template_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/trip-day-template.js */ "./src/view/trip-day-template.js");
/* harmony import */ var _view_trip_point_template_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./view/trip-point-template.js */ "./src/view/trip-point-template.js");
/* harmony import */ var _mocks_mocksData_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./mocks/mocksData.js */ "./src/mocks/mocksData.js");
...
const points = new Array(QUANTITY_PINS).fill().map(_mocks_mocksData_js__WEBPACK_IMPORTED_MODULE_9__["generateTripPoint"]);
...
render(tripEvents, Object(_view_trip_day_counter_template_js__WEBPACK_IMPORTED_MODULE_6__["createDayCounterTemplate"])(), `beforeend`);

const dayContainer = tripEvents.querySelector(`.trip-days`);

for (let i = 0; i < DAY_NUMBER; i++) {
  render(dayContainer, Object(_view_trip_day_template_js__WEBPACK_IMPORTED_MODULE_7__["createDayTemplate"])(), `beforeend`);
  const tripEventsContainer = tripEvents.querySelector(`.trip-events__list`);
  for (let k = 0; k < QUANTITY_PINS; k++) {
    render(tripEventsContainer, Object(_view_trip_point_template_js__WEBPACK_IMPORTED_MODULE_8__["createPointTemplate"])(points[k]), `beforeend`);
  }
}
...
/***/ "./src/view/trip-day-counter-template.js":
/*!***********************************************!*\
  !*** ./src/view/trip-day-counter-template.js ***!
  \***********************************************/
/*! exports provided: createDayCounterTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createDayCounterTemplate", function() { return createDayCounterTemplate; });
